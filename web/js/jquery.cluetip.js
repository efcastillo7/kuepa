  ...
  $.cluetip = {
    ...
    */
    defaults: {
      ...
      positionBy:       'topBottom',   // Sets the type of positioning: 'auto', 'mouse','bottomTop', 'topBottom', fixed'
      ...
      dropShadowSteps:  10,        // adjusts the size of the drop shadow
      ...
      //closeText: '<img src="cross.png" alt="close" />' agrega una imagen
          ...
          var ajaxSettings = {
            ...
            beforeSend: function(xhr, settings) {
              ...
              if (opts.waitImage) {
                ...
                //$("*").addClass('loading-cursor'); //add cursor
                $(".container #calendar .fc-content *").addClass('loading-cursor'); //add cursor
    ...
    ************************************************************/
    ...
    function createDropShadows($cluetip, options, newDropShadow) {
      ...
      if ($.cluetip.boxShadow) {
        if ( dropShadowSteps ) {
          dsStyle = '0px 4px ' + dropShadowSteps + 'px rgba(0,0,0,0.5)';
        }
