<div class="md-modal" id="modal-create-video_session-form">
    <div class="md-content">
        <h3 id="title"></h3>
        <div>
            <div id="modal-create-video_session-form-container">
                <?php echo include_partial("video_session/form", array('form' => $form)) ?>
            </div>
