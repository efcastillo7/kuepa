<form action="<?php echo '/kuepa_api_dev.php/lesson' . ($form->isNew() ? "" : "/" . $form->getObject()->getId()) ?>" method="POST" id="create-lesson-form<?php echo ($form->isNew() ? "" : "-" . $form->getObject()->getId()) ?>">
    <?php if(!$form->isNew()): ?>
