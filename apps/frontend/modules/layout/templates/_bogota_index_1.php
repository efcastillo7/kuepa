...
<script type="text/javascript">
	$(document).ready(function(){
		...
		slides[1] = function(){
			...
			var data = '[{"id":"1","position":"1","course":{"id":"","name":"","color":"red","image":"\/uploads\/thumbnail\/82deb81a5c8c482876fd696bdd4fe96a4b521236.png"},"chapter":{"id":"3959","name":"Proximamente te asignaremos tu camino de aprendizaje"},"lesson":{"id":"3964","name":"Camino de Aprendizaje"}}]';
