...
class Version37 extends Doctrine_Migration_Base
{
    public function up()
    {
        ...
        $this->createForeignKey('sf_guard_forgot_password', 'sf_guard_forgot_password_user_id_sf_guard_user_id_1', array(
             'name' => 'sf_guard_forgot_password_user_id_sf_guard_user_id_1',
             'local' => 'user_id',
             'foreign' => 'id',
        ...
        $this->createForeignKey('sf_guard_remember_key', 'sf_guard_remember_key_user_id_sf_guard_user_id_1', array(
             'name' => 'sf_guard_remember_key_user_id_sf_guard_user_id_1',
             'local' => 'user_id',
             'foreign' => 'id',
             'foreignTable' => 'sf_guard_user',
             'onUpdate' => '',
        ...
        $this->addIndex('sf_guard_user', 'is_active_idx', array(
             'fields' => 
             array(
              0 => 'is_active',
             ),
    ...
    public function down()
    {
        ...
        $this->dropForeignKey('sf_guard_forgot_password', 'sf_guard_forgot_password_user_id_sf_guard_user_id_1');
        ...
        $this->dropForeignKey('sf_guard_remember_key', 'sf_guard_remember_key_user_id_sf_guard_user_id_1');
        ...
        $this->removeIndex('sf_guard_user', 'is_active_idx', array(
             'fields' => 
             array(
              0 => 'is_active',
             ),
